    ...
    public static void main(String[]args) throws IOException, InterruptedException{
        ...
        if(args.length!=1){
            ...
            try{
                ...
                //Create the thread and initialize the communication with that connection.
                ...
                while(true){ 
                    ...
                    i++;
                    //This if verify if the flag clicked changed to another value, this means 
                    //that the button of send was clicked.
                    if(clicked == 0){
                        ...
                        if(text.getText().length() != 0){
                        	...
                        	//This obtain what is in the text field of the message and 
                        	//concatenate to the format message with the name of the user.
                        	mensaje = unserName + ": " + text.getText() + "\n";
                        
                        	//Then this set the text field of the message to blank and concatenate 
                        	//to the current data in the text area where are all the messages.
                        	text.setText("");
                        ...
                        //The flag that we use to wait if the button was clicked, we return it to the initial value, 
